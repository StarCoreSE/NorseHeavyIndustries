...
namespace Scripts {   
    partial class Parts {
        ...
        SupportDefinition Support_Module_Test => new SupportDefinition
        {
            ...
            {
                PartName = "Support Module Test", // name of weapon in terminal, should be unique for each weapon definition that shares a SubtypeId (i.e. multiweapons)
